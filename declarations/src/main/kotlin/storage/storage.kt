...
external class StorageAreaSync {
    /**
     * Gets one or more items from storage.
     */
    fun get(keys: String): Promise<Items3>

    /**
     * Gets one or more items from storage.
     */
    fun get(keys: Array<String>): Promise<Items3>

    /**
     * Gets one or more items from storage.
     */
    fun get(keys: Keys5): Promise<Items3>
     ...
     * Sets multiple items.
     */
    fun set(items: Items4): Promise<Any>
